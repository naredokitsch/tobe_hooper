...
void insertSymbol(char* tok){
    int tmpLength = 0;
    int *tmp = (int*)realloc(makeSymbolPointer(tok),400);
	free(tmp);

    do{}while(*(tok + (tmpLength++)) != '\0');
...
//FUNCIONES VALIDADORES DE ELEMENTOS EXISTENTES//////////////////////////////////////////////////////
...
printf ("\nCOMENZANDO A INSERTAR simbolo\n");
    insertSymbol("simbolo");
printf ("\nCOMENZANDO A INSERTAR cadena\n");
    insertString("cadena");
/*
    showTokenTable();
    showSymbolsTable();
